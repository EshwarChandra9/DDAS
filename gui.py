...
def authentication():
    subprocess.run(["python", "C:\\Users\\chandu\\Desktop\\Major Project\\reg.py"])

def drowsiness():
    subprocess.run(["python", "C:\\Users\\chandu\\Desktop\\Major Project\\drowsinessDetector.py"])
...
bg_image = Image.open("C:\\Users\\chandu\\Desktop\\Major Project\\3.jpg")  
